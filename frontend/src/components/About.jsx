      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-black font-serif">Notre Histoire</h3>
          ...
          <div className="bg-primary-dark rounded-lg p-8 hover:bg-primary-dark/80 transition-all duration-300 transform hover:scale-105">
            <h4 className="text-2xl font-bold text-black font-serif mb-4">Expérience Unique</h4>
            <p className="text-gray-800 font-sans leading-relaxed mb-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="ml-2 text-gray-800 font-semibold">Excellence reconnue</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {features.map((feature, index) => (
            <div
              key={index}
              className="text-center p-6 bg-primary-dark/30 rounded-lg hover:bg-primary-dark/50 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg"
            >
              <div className="flex justify-center mb-4">
                {getIcon(feature.icon)}
              </div>
              <h3 className="text-xl font-semibold text-black font-serif mb-3">
                {feature.title}
              </h3>
        ...
        {/* Testimonials */}
        <div className="bg-primary-dark/20 rounded-2xl p-8 md:p-12">
